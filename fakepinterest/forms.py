...
class FormPostPhoto(FlaskForm):
    PhotoField = FileField('Foto', validators=[DataRequired()])
    #DescriptionField = StringField('Descrição', validators=[Length(max=200)])
    SubmitField = SubmitField('Postar Foto')